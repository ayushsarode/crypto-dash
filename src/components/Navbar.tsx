...
<div className="navbar-start">
    ...
    <Link href={"#"} className="btn btn-ghost text-[1.5rem]">CryptoDash</Link>
  </div>
  ...
  <div className="navbar-end ">
    ...
    <li className="">
      ...
      <li>
    <Link href={"#"} className="btn rounded-full px-6 bg-white text-black text-[1rem] hover:bg-white ">Sign Up <FaUserPlus /></Link> 
    </li>
    </ul>
  </div>
</div>
